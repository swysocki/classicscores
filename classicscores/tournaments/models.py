...
class Tournament(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields = ['year', 'league', 'location', 'name'], name='unique tournament')
        ]
...
class Score(models.Model):
    ...
    tournament_format = models.CharField(
        max_length=3, choices=FORMAT_CHOICES
    )
    ...
    division = models.CharField(
        max_length=3, choices=DIVISION_CHOICES
    )
